	...
	return (
		<aside className="w-72 shrink-0 h-[calc(100vh-4rem)]">
			<Card className="h-full flex flex-col">
				...
				<CardContent className="flex flex-col gap-4 h-[calc(100%-3.5rem)] overflow-y-auto">
					<UserProfile />
					...
					<div className="space-y-2">
						...
						<Link className="text-sm underline block" href="/recommendations">Feedback</Link>
					</div>
					<div className="pt-2 border-t" />
					<RecommendationsList limit={5} showHeader={true} />
				</CardContent>
			</Card>
		</aside>
	);
